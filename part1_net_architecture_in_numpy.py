...
def zad2_two_layer_net(student_id):
    ...
    model.hidden_layer.W[:, 0] = [-1.0, -1.0]
    model.hidden_layer.W[:, 1] = [1.0, 1.0]
    model.hidden_layer.b[:] = [1.5, -0.5]

    model.output_layer.W[:, 0] = [1.0, 1.0]
...
if __name__ == '__main__':
    ...
    student_id = 193423         # Twój numer indeksu, np. 102247
